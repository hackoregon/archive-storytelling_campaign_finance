#\o /Users/john.cohoon/Sites/storytelling/storytelling_campaign_finance/json/large_donors_month.json
...
from (
    ...
    where book_type = 'Individual' and sub_type = 'Cash Contribution' and amount > 1000
